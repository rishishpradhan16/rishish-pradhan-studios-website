...
export const fontData: FounderProfile = {
  ...
  contentPlatforms: {
    ...
    status: "✅ Live & Growing",
    channels: [
      { platform: "YouTube Primary", metric: "8,000+ Subs", desc: "Tech, coding tutorials & public build logs" },
      { platform: "YouTube Secondary", metric: "4,500+ Subs", desc: "Specialized tech experiments & breakdowns" },
      { platform: "Instagram", metric: "8,000+ Followers", desc: "Engineering mindset, career tips & micro-content" },
    ],
  },
  achievements: [
    {
    ...
    },
    {
      ...
      achievement: "Grew 20,000+ audience across YouTube and Instagram",
      impact: "Building in public & empowering developers worldwide",
      tech: ["Fact-Based Systems", "YouTube 8K+", "Insta 8K+"],
      iconName: "Users",
    },
  ],
};
